...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'RainappConfig', fields ['slug']
        db.create_unique('lizard_rainapp_rainappconfig', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RainappConfig', fields ['slug']
        db.delete_unique('lizard_rainapp_rainappconfig', ['slug'])
