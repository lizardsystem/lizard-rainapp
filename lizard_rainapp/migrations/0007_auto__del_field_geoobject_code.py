...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GeoObject.code'
        db.delete_column('lizard_rainapp_geoobject', 'code')


    def backwards(self, orm):
        
        # Adding field 'GeoObject.code'
        db.add_column('lizard_rainapp_geoobject', 'code', self.gf('django.db.models.fields.CharField')(max_length=16, null=True), keep_default=False)
